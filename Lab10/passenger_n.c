...
int main(int argc, char *argv[])
{
    ...
    char line[78];
    int length = atoi(fgets(line, sizeof(line), in));
    ...
    for(int i = 0; i < length; i++)
    {
        ...
        strcpy(passenger[i].passport_number, strtok(line, ";"));
        passenger[i].age = atoi(strtok(NULL, ";"));
        strcpy(passenger[i].full_name, strtok(NULL, ";"));
        passenger[i].baggage_weight = atof(strtok(NULL, ";"));
    }
